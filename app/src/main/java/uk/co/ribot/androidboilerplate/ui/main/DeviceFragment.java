 ...
 */
public class DeviceFragment extends Fragment implements DeviceUi, View.OnClickListener {
...
//        mMainPresenter.detachView();
    ...
    public void onClick(View v) {
        Toast.makeText(this.getActivity(), "Delete " + v.getId() + " " + v.getTag(), Toast.LENGTH_SHORT).show();
    }
